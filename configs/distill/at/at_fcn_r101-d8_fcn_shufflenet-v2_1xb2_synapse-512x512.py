...
teacher_ckpt = '/home/jz207/workspace/zhangdw/ex_kd/work_dirs/fcn_r101-d8_1xb2-80k_synapse-512x512/5-run_20230604_143027/run4/best_mDice_85-27_iter_72000.pth'  # noqa: E501
teacher_cfg_path = 'configs/resnet/fcn_r101-d8_1xb2-80k_synapse-512x512.py'  # noqa: E501
student_cfg_path = 'configs/shufflenet_v1/shufflenet-v1-d8_fcn_1xb2-80k_synapse-512x512.py'  # noqa: E501
model = dict(
    _scope_='razor',
    ...
    distiller=dict(_scope_='razor',
        ...
        student_recorders=dict(
            bb_s2=dict(type='ModuleOutputs', source='backbone.layers.0.3'),
            bb_s3=dict(type='ModuleOutputs', source='backbone.layers.1.7'),
            bb_s4=dict(type='ModuleOutputs', source='backbone.layers.2.3')),
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='synapse', name='at_fcn_r101_fcn_sv2-80k'),
