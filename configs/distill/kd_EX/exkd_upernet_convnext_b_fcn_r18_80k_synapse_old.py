_base_ = [
    '../../_base_/datasets/synapse_old.py',
...
teacher_cfg_path = 'configs/convnext/conv_next_b-synapse-80k_old.py'  # noqa: E501
student_cfg_path = 'configs/resnet/fcn_r18-kd-d8_1xb2-40k_synapse-512x512_old.py'  # noqa: E501
model = dict(
    _scope_='razor',
