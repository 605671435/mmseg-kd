...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/stuff_train2017.json',
        data_prefix=dict(
            img_path='train2017/',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/stuff_val2017.json',
        data_prefix=dict(
            img_path='val2017/',
