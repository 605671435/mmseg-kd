...
class BaseAlgorithm(BaseModel):
    ...
    def __init__(self,
        ...
        if isinstance(architecture, Dict):
            ...
            if isinstance(architecture['cfg_path'], str):
            ...
            #     architecture = SEG_MODELS.build(cfg.model)
                architecture = build_model(cfg.model, task)
            else:
                # architecture = SEG_MODELS.build(architecture['cfg_path'])
                architecture = build_model(architecture['cfg_path'], task)
